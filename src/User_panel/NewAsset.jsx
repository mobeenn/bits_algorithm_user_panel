import { addAssets } from "@/api/auth";
...
export const NewAsset = () => {
   ...
   //   ~ handling on add asset
   const handleAddAsset = async ({ assetStatus }) => {
      ...
      <>
         <div className="update rounded-[8px] mx-7 px-7">
            ...
            <div className="flex flex-col gap-4 py-4 md:flex-row">
               <button
                  onClick={() =>
                     handleAddAsset({ assetStatus: "Under Verification" })
                  }
               ...
               <button
                  onClick={() => handleAddAsset({ assetStatus: "Draft" })}
