...
export const Footer = () => {
   return (
      <>
         <footer className="mx-4 flex flex-col items-center justify-between py-6 text-white md:mx-8 md:flex-row">
            <div className="mb-4 md:mb-0">
               <p className="font-roboto text-base font-normal leading-6 text-white text-nowrap">
